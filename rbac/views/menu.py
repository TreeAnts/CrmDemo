...
def menu_list(request):
    ...
    menus = models.Menu.objects.annotate(menu_count=Count("menus__id"))
    ...
    return render(request, 'rbac/menu_list.html',context=context)
...
def second_menu_add(request,menu_id):
    ...
    if request.method == 'GET':
        form = SecondMenuModelForm(initial={
            'menu': menu_object
        })
        return render(request, 'rbac/change.html',{'form':form})
...
def multi_permissions(request):
    ...
    """
    {
        ...
        'rbac:role_edit':{'name': 'rbac:role_edit', 'url': '/rbac/role/edit/(?P<pk>[0-9]+)/'},
        ....
    }
    """
    ...
    # 2. 获取数据库中所有的URL
    permissions = models.Permission.objects.all().values('id', 'title', 'name', 'url', 'menu_id', 'parent_id')
    ...
    for name, value in permission_dict.items():
        ...
        if value['url'] != router_row_dict['url']:
            value['url'] = '路由：%s 和数据库不一致' % (router_row_dict['url'])
...
def distribute_permissions(request):
    ...
    # 业务中的用户表 "apps.demo.models.UserInfo"
    ...
    """
    [
        {id:1,title:菜单1,children:[{id:1,title:x1, menu_id:1,'children':[{id:11,title:x2,parent:1},] },{id:2,title:x1, menu_id:1 },]},
    ...
    """
       {
           1:{id:1,title:菜单1,children:[{id:1,title:x1, menu_id:1,children:[{id:11,title:x2,parent:1},] },{id:2,title:x1, menu_id:1,children:[] },]},
    ...
    """
    [
        {id:1,title:x1, menu_id:1,children:[{id:11,title:x2,parent:1},] },   
    ...
    """
        {
            1:{id:1,title:x1, menu_id:1,children:[{id:11,title:x2,parent:1},] },   
    ...
    """
    [
        {id:11,title:x2,parent:1},
        {id:12,title:x2,parent:1},
        {id:13,title:x2,parent:2},
        {id:14,title:x2,parent:3},
        {id:15,title:x2,parent:4},
        {id:16,title:x2,parent:5},
    ]
    """
    for row in all_permission_list:
        ...
        if not parent:
            continue
        all_second_menu_dict[parent]['children'].append(row)
