...
class ClassList(models.Model):
    ...
    class_teacher = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes', on_delete=models.PROTECT, limit_choices_to={'depart__title': '教质部'})
...
class ConsultRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="跟踪人", to='UserInfo', null=True, on_delete=models.SET_NULL)
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', help_text="谁签的单就选谁", null=True, on_delete=models.SET_NULL)
    pay_type_choices = [
        (1, "报名费"),
        (2, "学费"),
        (3, "退学"),
    ...
    class_list = models.ForeignKey(verbose_name="申请班级", to="ClassList", on_delete=models.PROTECT)
    ...
    confirm_user = models.ForeignKey(verbose_name="审批人", to='UserInfo', related_name='confirms', null=True, blank=True, on_delete=models.SET_NULL)
...
class Student(models.Model):
    ...
    学生表
    """
    customer = models.OneToOneField(verbose_name='客户信息', to='Customer', on_delete=models.PROTECT)
...
class CourseRecord(models.Model):
    ...
    上课记录表
    """
    class_object = models.ForeignKey(verbose_name="班级", to="ClassList", on_delete=models.PROTECT)
    day_num = models.IntegerField(verbose_name="节次")
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo', on_delete=models.PROTECT)
...
class StudyRecord(models.Model):
    ...
    学生考勤记录
    """
    course_record = models.ForeignKey(verbose_name="第几天课程", to="CourseRecord", on_delete=models.PROTECT)
    student = models.ForeignKey(verbose_name="学员", to='Student', on_delete=models.PROTECT)
    record_choices = (
        ('checked', "已签到"),
        ('vacate', "请假"),
        ('late', "迟到"),
